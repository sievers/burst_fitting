...
if ~exist('dat')
  ...
  crap=load(['chains/chain_qu_ramp_real_newdat_good_760_' tag 'chan.txt_1.trial']);crap=crap(round(0.2*end):end,3:end);
...
myopts.outroot=['chains/chain_qu_ramp_real_newdat_good_760_' tag 'chan.txt'];
