...
crap=read_chains('chain_polfit.txt',0.2,'');crap=crap(:,2:end);
best_guess=mean(crap);
mycov=cov(crap);



[pp,ll,qft,uft,nvec]=mcmc_burst_polfit(dat_q_use,dat_u_use,freq_use,best_guess,0.25*mycov*0.5,dt,1.0);
