function[pp,ll,qft,uft,nvec]=mcmc_burst_polfit(dat_q,dat_u,freqs,guess,sigs,dt,nu_min,fix_params,true_params)
...
tic;chisq=get_burst_chisq_qu_c(guess,qft,uft,freqs,n,nvec,dt,imin);toc
...
for j=2:nstep
  ...
  if ((guess(2)<0)|(guess(1)<0))
    ...
    chisq=get_burst_chisq_qu_c(guess,qft,uft,freqs,n,nvec,dt,imin);
  end
