...
if ~exist('dat')
  ...
  crap=load('chains/chain_tt_scatfit_kiyo_test.txt_1');crap=crap(:,3:end);
end
...
myopts.nstep=300000;
myopts.outroot='chains/chain_tt_scatfit_kiyo_wcov.txt';
myopts.func=@get_burst_chisq_scatfit_cached_c;
[pp,ll,dataft,nvec,imin]=mcmc_burst_intensity(dat,myopts,freq_use,best_guess,0.6*mycov,dt,2.0);
return
